...
describe('Instant chat test cases', function () {
  //1) 
  ...
  it("login user can open other member profile information", function () {
    obj.clickUserName();
    expect(obj.checkInstantRightSidePannelIsOpend()).toEqual('Instant Group Profile');
  });

  //16
  it("login user can see other user instant group members", function () {
